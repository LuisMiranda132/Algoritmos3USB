...
public abstract class Digraph {
    ...
    /**
     * Funcion: equals
     * Descripcion: indica si dos Digraph son iguales.
     * Parametros: 
     * Precondicion:
     * Postcondicion:
     */
    public boolean equals(Object g) {
    	if (!(g instanceof Digraph)) {
    		...
    		Lista<Nodo> listitaNodos1 = this.getNodos();
    		Lista<Nodo> listitaNodos2 = ((Digraph) g).getNodos();
    		Lista<Arco> listitaArcos1 = this.getArcos();
    		Lista<Arco> listitaArcos2 = ((Digraph) g).getArcos();
    		
    		if (listitaNodos1.equals(listitaNodos2) && listitaArcos1.equals(listitaArcos2)){
    			return true;
    		}
    		else {
    			return false;
